...
public class BezierScreen extends Screen {
    ...
    private static int calcX(double t){
        double x=0;
        //(1-t)*dots[0].x + t*dots[1].x
        //Math.pow(1-t,2)*dots[0].x + 2*t*(1-t)*dots[1].x + Math.pow(t,2)*dots[2].x;
    ...
    private static int calcY(double t){
        double y=0;
        //(1-t)*dots[0].y + t*dots[1].y;
        //Math.pow(1-t,2)*dots[0].y + 2*t*(1-t)*dots[1].y + Math.pow(t,2)*dots[2].y;
